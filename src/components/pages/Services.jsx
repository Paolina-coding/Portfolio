        ...
        <div className="row g-5 my-5 justify-content-center">
          <div className="col-md-4">
            <div className="card h-100 text-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-brush card-img-top text-primary m-3" viewBox="0 0 16 16">
          ...
          <div className="col-md-4">
            <div className="card h-100 text-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-code-slash card-img-top text-primary m-3" viewBox="0 0 16 16">
          ...
          <div className="col-md-4">
            <div className="card h-100 text-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-search card-img-top text-primary m-3" viewBox="0 0 16 16">
